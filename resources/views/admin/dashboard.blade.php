...
<head>
    <!-- 
    ============================================================
    BAGIAN: META & DEPENDENSI UTAMA
    ============================================================
    - Meta charset & viewport untuk responsif
    - Bootstrap 5 untuk layout dan komponen UI
    - Font Plus Jakarta Sans untuk tipografi modern
    - Bootstrap Icons untuk ikon-ikon
    - DataTables CSS untuk fitur sorting, search, pagination pada tabel laporan
    - SweetAlert2 untuk notifikasi popup yang menarik
    ============================================================
    -->
    <meta charset="UTF-8">
    ...
    <style>
        ...
        ============================================================
        Digunakan untuk memudahkan maintenance warna dan ukuran global.
        Ubah nilai di sini jika ingin mengganti tema warna.
        ============================================================
        */
        :root {
            --bg-color: #050b18;          /* Warna latar belakang utama */
            --primary-blue: #3b82f6;      /* Warna biru utama untuk aksen */
            --accent-purple: #a855f7;     /* Warna ungu untuk gradien */
            --card-glass: rgba(255, 255, 255, 0.03);  /* Efek kaca untuk card */
            --border-glass: rgba(255, 255, 255, 0.08); /* Warna border efek kaca */
            --sidebar-width: 280px;       /* Lebar sidebar, mudah diubah */
        }
        ...
        /* 
        ============================================================
        STYLING KHUSUS DATATABLES (PAGINATION & SEARCH)
        ============================================================
        Override style default DataTables agar sesuai tema gelap dashboard.
        ============================================================
        */
        .dt-paging {
        ...
        /* 
        ============================================================
        EFEK BACKGROUND BLUR (GLASSMORPHISM)
        ============================================================
        Menciptakan efek latar belakang dengan blur untuk elemen-elemen tertentu.
        ============================================================
        */
        body::before {
        ...
        KOMPONEN SIDEBAR
        ============================================================
        Sidebar dengan efek glass, fixed di sisi kiri.
        ============================================================
        */
        .sidebar {
        ...
        /* 
        ============================================================
        KOMPONEN CARD & TABEL DENGAN EFEK KACA
        ============================================================
        */
        .glass-card {
        ...
        /* Tabel khusus dengan efek row spacing */
        ...
        /* Styling Modal dengan tema gelap */
        .modal-content {
        ...
        /* Komponen log aktivitas (timeline) */
        .log-container {
            max-height: 400px;
            overflow-y: auto;
            padding-right: 10px;
        ...
        /* Responsive: untuk layar tablet & mobile */
...
<body>
    ...
    SIDEBAR NAVIGASI
    ============================================================
    Berisi menu navigasi utama: Dashboard, Pengaduan, Kategori, Lokasi, Data Siswa, dan Logout.
    Menggunakan Bootstrap Tabs (pills) untuk perpindahan konten.
    ============================================================
    -->
    <div class="sidebar">
        <div class="mb-5 px-3">
    ...
    ============================================================
    Area tempat semua tab/konten halaman akan ditampilkan.
    ============================================================
    -->
    <div class="main-content">
        ...
        <!-- 
        ============================================================
        KONTEN TAB (MENGGUNAKAN BOOTSTRAP PILLS)
        ============================================================
        Setiap tab berisi konten yang berbeda:
        - pills-dash: Dashboard statistik dan log aktivitas
        - pills-laporan: Tabel pengaduan dengan DataTables (fitur pencarian & pagination)
        - pills-kategori: CRUD kategori fasilitas
        - pills-lokasi: CRUD lokasi fasilitas
        - pills-user: CRUD data siswa
        ============================================================
        -->
        <div class="tab-content" id="v-pills-tabContent">
            
            <!-- TAB 1: DASHBOARD (Statistik & Log) -->
            <div class="tab-pane fade show active" id="pills-dash" role="tabpanel">
                <!-- Kartu statistik (Total, Menunggu, Proses, Selesai) -->
                        ...
                        <div class="glass-card">
                            ...
                            <div class="table-responsive">
                                <table class="table text-black custom-table">
                                    <thead>
                                        <tr><th>Siswa</th><th>Laporan</th><th>Status</th></tr>
                                    </thead>
                                    <tbody>
                                        @foreach($laporan->take(5) as $l)
                                        <tr><td class="fw-700">{{ $l->siswa->nama }}</td>
                                            <td class="text-black-50 small">{{ Str::limit($l->ket, 35) }}</td>
                                            <td>@php $st = $l->aspirasi->status ?? 'Menunggu'; @endphp
            ...
            <!-- 
            ============================================================
            TAB 2: PENGADUAN (DENGAN DATATABLES)
            ============================================================
            Fitur: 
            - Pencarian (search)
            - Pagination dengan jumlah data bisa dipilih (10,25,50,100)
            - Sorting otomatis (kecuali kolom bukti & aksi)
            - Responsive
            ============================================================
            -->
            <div class="tab-pane fade" id="pills-laporan" role="tabpanel">
                <div class="glass-card">
                    ...
                    <div class="table-responsive">
                        <!-- ID tableLaporan wajib ada untuk inisialisasi DataTables -->
            ...
            <!-- TAB 5: DATA SISWA (CRUD Sederhana) -->
    ...
    <!-- 
    ============================================================
    MODAL-MODAL UNTUK CRUD (Tambah/Edit/Hapus)
    ============================================================
    Setiap modal memiliki fungsi spesifik:
    - modalAddLokasi / modalEditLokasi : CRUD Lokasi
    - modalAddKategori / modalEditKategori : CRUD Kategori
    - modalTanggapi : Update status & feedback pengaduan
    - modalAddSiswa : Tambah data siswa
    ============================================================
    -->
    ...
    <!-- MODAL EDIT LOKASI (Looping setiap data) -->
    @foreach($lokasi as $l)
    ...
    <!-- 
    ============================================================
    MODAL TANGGAPI PENGADUAN (Update status & feedback)
    ============================================================
    Fungsi: Menampilkan form untuk admin menanggapi laporan siswa
    Fitur:
    - Melihat foto bukti kerusakan dari siswa
    - Melihat foto bukti perbaikan (jika sudah ada)
    - Mengubah status laporan (Menunggu/Proses/Selesai)
    - Mengupload bukti foto perbaikan baru
    - Menulis tanggapan/feedback admin

    CATATAN: Modal ini di-loop untuk setiap laporan (1 modal per laporan)
    ============================================================
    -->
    @foreach($laporan as $l)
    <div class="modal fade" id="modalTanggapi{{ $l->id_pelaporan }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <form action="/admin/tanggapi" method="POST" enctype="multipart/form-data" class="modal-content">
                @csrf
                <!-- ID Laporan dikirim sebagai hidden input -->
                <input type="hidden" name="id_pelaporan" value="{{ $l->id_pelaporan }}">
                
                <div class="modal-body p-4">
                    <div class="row g-4">
                        <!-- KOLOM KIRI: TAMPILAN FOTO -->
                        <div class="col-md-5">
                            <!-- Foto bukti kerusakan dari siswa -->
                            <label class="small text-white-50 mb-2">Foto Laporan Siswa:</label>
                            <img src="{{ asset('storage/'.$l->foto) }}" 
                                class="img-fluid rounded-4 shadow border border-white border-opacity-10 mb-3">
                            
                            <!-- Foto bukti perbaikan (jika sudah ada dari tanggapan sebelumnya) -->
                            @if(isset($l->aspirasi->foto))
                            <label class="small text-success mb-2">Foto Bukti Perbaikan:</label>
                            <img src="{{ asset('storage/'.$l->aspirasi->foto) }}" 
                                class="img-fluid rounded-4 border border-success border-opacity-50">
                            @endif
                        </div>
                        
                        <!-- KOLOM KANAN: FORM KELOLA LAPORAN -->
                        <div class="col-md-7">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-select">
                                    <option value="Menunggu" {{ ($l->aspirasi->status ?? '') == 'Menunggu' ? 'selected' : '' }}>
                                        Menunggu
                                    </option>
                                    <option value="Proses" {{ ($l->aspirasi->status ?? '') == 'Proses' ? 'selected' : '' }}>
                                        Proses
                                    </option>
                                    <option value="Selesai" {{ ($l->aspirasi->status ?? '') == 'Selesai' ? 'selected' : '' }}>
                                        Selesai
                                    </option>
                                </select>
                            </div>
                            
                            <!-- Upload Bukti Perbaikan (opsional) -->
                            <div class="mb-3">
                                ...
                                <small class="text-white-50">Format: JPG/PNG, maksimal 2MB</small>
                            </div>
                            
                            <!-- Textarea Tanggapan Admin (WAJIB diisi) -->
                            <div class="mb-4">
    ...
    <!-- 
    ============================================================
    MODAL ADD SISWA (TAMBAH DATA SISWA)
    ============================================================
    Fungsi: Form untuk admin menambahkan akun siswa baru
    Field yang diisi:
    - NIS (Nomor Induk Siswa) - unique, tidak boleh duplikat
    - Nama Lengkap
    - Kelas
    ...
    1. jQuery - untuk manipulasi DOM dan event handling
    2. Bootstrap Bundle - untuk komponen modal, dropdown, dll (termasuk Popper)
    3. DataTables - untuk fitur sorting, searching, pagination pada tabel laporan
    4. SweetAlert2 - untuk notifikasi popup yang menarik
    ============================================================
    -->
    ...
    <script>
         ...
         * ============================================================
         * Mengaktifkan fitur DataTables pada tabel laporan (#tableLaporan)
         * Fitur yang diaktifkan:
         * - Pencarian (search) dengan placeholder kustom
         * - Pagination dengan style full_numbers (First, Prev, Next, Last)
         * - Pemilihan jumlah data per halaman (10, 25, 50, 100)
         * - Sorting otomatis (kecuali kolom yang ditentukan)
         * - Informasi jumlah data yang ditampilkan
         * 
         * CATATAN: Tabel harus memiliki ID "tableLaporan"
         * ============================================================
         */
        $(document).ready(function() {
            $('#tableLaporan').DataTable({
                // Tipe pagination: menampilkan tombol First, Prev, Next, Last
                "pagingType": "full_numbers",
                
                // Pilihan jumlah data yang ditampilkan per halaman
                "lengthMenu": [10, 25, 50, 100],
                
                // Konfigurasi teks dalam bahasa Indonesia
                "language": {
                    "lengthMenu": "_MENU_ data per halaman",  // Teks untuk dropdown jumlah data
                    "sSearch": "<i class='bi bi-search me-2'></i>", // Ikon pencarian (teks diganti ikon)
                    "searchPlaceholder": "Cari laporan...",    // Placeholder input pencarian
                    "sEmptyTable": "Tidak ada data",           // Pesan jika tabel kosong
                    "sInfo": "Menampilkan _START_ - _END_ dari _TOTAL_ laporan", // Info halaman
                    "sInfoEmpty": "Menampilkan 0 laporan",     // Info jika tidak ada data
                    "sInfoFiltered": "(disaring dari _MAX_ data)", // Info saat pencarian
                    "sZeroRecords": "Data tidak ditemukan",    // Pesan jika pencarian tidak ditemukan
                    "paginate": {
                        "first": "«",      // Tombol halaman pertama
                        "previous": "‹",   // Tombol halaman sebelumnya
                        "next": "›",       // Tombol halaman berikutnya
                        "last": "»"        // Tombol halaman terakhir
                    }
                },
                ...
                // Pengurutan default: kolom index 3 (Status) secara descending (terbaru di atas)
                "order": [[3, 'desc']],
                
                // Konfigurasi kolom tertentu
                "columnDefs": [
                    // Kolom index 0 (Bukti) dan kolom index 4 (Aksi) tidak bisa di-sort
         ...
         * 
         * @param string url - URL tujuan untuk proses delete
         * @param string message - Pesan konfirmasi yang ditampilkan
         * 
         * PROSES:
         * 1. Tampilkan dialog konfirmasi dengan SweetAlert
         * 2. Jika user klik "Ya, Hapus!", redirect ke URL yang diberikan
         * 3. Jika user klik "Batal", tutup dialog tanpa aksi
         * 
         * PENGGUNAAN:
         * onclick="confirmDelete('/admin/kategori/hapus/1', 'Hapus kategori ini?')"
         * ============================================================
         */
        function confirmDelete(url, message) {
            Swal.fire({
                ...
                confirmButtonColor: '#3b82f6', // Warna biru untuk tombol konfirmasi
                cancelButtonColor: '#ef4444',  // Warna merah untuk tombol batal
                confirmButtonText: 'Ya, Hapus!',
                cancelButtonText: 'Batal',
                background: '#0f172a',         // Background gelap sesuai tema
                color: '#ffffff'               // Teks putih
            }).then((result) => { 
                if (result.isConfirmed) {
                    // Redirect ke URL delete jika user mengkonfirmasi
        ...
        /**
         * ============================================================
         * NOTIFIKASI SUKSES (SESSION SUCCESS)
         * ============================================================
         * Menampilkan SweetAlert jika ada session 'success' dari Laravel
         * Digunakan setelah operasi CREATE, UPDATE, DELETE yang berhasil
         * 
         * Contoh: return back()->with('success', 'Data berhasil disimpan!');
         * ============================================================
         */
        @if(session('success'))
            Swal.fire({
        ...
        /**
         * ============================================================
         * NOTIFIKASI ERROR (SESSION ERROR)
         * ============================================================
         * Menampilkan SweetAlert jika ada session 'error' dari Laravel
         * Biasanya digunakan saat:
         * - Gagal menghapus data karena masih terpakai (foreign key constraint)
         * - Validasi gagal di sisi server
         * 
         * Contoh: return back()->with('error', 'Data tidak bisa dihapus!');
         * ============================================================
         */
        @if(session('error'))
            Swal.fire({
                ...
                background: '#0f172a',
                color: '#ffffff',
                confirmButtonColor: '#ef4444'  // Warna merah untuk tombol
            });
        @endif

        /**
         * ============================================================
         * NOTIFIKASI VALIDASI ERROR ($errors->any())
         * ============================================================
         * Menampilkan SweetAlert jika terdapat error validasi dari Laravel
         * Biasanya terjadi ketika:
         * - Input form tidak memenuhi aturan validasi
         * - File upload melebihi batas ukuran
         * - Field yang wajib diisi kosong
         * 
         * Semua pesan error digabungkan menjadi satu string
         * ============================================================
         */
        @if($errors->any())
            Swal.fire({
                ...
                // Menggabungkan semua pesan error menjadi satu string dengan spasi
